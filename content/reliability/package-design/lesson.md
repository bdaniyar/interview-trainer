...
- объяснить `Separation of concerns` своими словами и связать с backend-сценарием;
...
В теме **Separation of concerns** важно уверенно объяснять следующие части:

### Separation of concerns

Для `Separation of concerns` проведи границу слоя и dependency direction, затем покажи test без реальной инфраструктуры.
...
1. Объясни **Separation of concerns** по схеме «определение → механизм → пример → ограничение».
...
- дай точное определение **Separation of concerns**;
