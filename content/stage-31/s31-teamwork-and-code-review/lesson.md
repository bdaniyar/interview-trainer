...
- объяснить `accepting feedback` своими словами и связать с backend-сценарием;
- объяснить `explaining trade-offs` своими словами и связать с backend-сценарием;
- объяснить `focused PR` своими словами и связать с backend-сценарием;
...
В теме **Teamwork and code review** важно уверенно объяснять следующие части:

### accepting feedback

Для `accepting feedback` подготовь ответ на 60–90 секунд: context, личное действие, результат и проверяемый follow-up.
...
Для `focused PR` подготовь ответ на 60–90 секунд: context, личное действие, результат и проверяемый follow-up.

### conflict resolution

Для `conflict resolution` подготовь ответ на 60–90 секунд: context, личное действие, результат и проверяемый follow-up.
...
1. Объясни **Teamwork and code review** по схеме «определение → механизм → пример → ограничение».
...
- дай точное определение **Teamwork and code review**;
