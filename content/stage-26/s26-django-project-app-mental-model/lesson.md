...
- объяснить `Django project/app mental model` своими словами и связать с backend-сценарием;
...
В теме **Django project/app mental model** важно уверенно объяснять следующие части:

### Django project/app mental model

Для `Django project/app mental model` сопоставь Django/DRF abstraction с request, ORM query count, validation и permissions.
...
1. Объясни **Django project/app mental model** по схеме «определение → механизм → пример → ограничение».
...
- дай точное определение **Django project/app mental model**;
