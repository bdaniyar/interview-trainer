...
- объяснить `FIFO` своими словами и связать с backend-сценарием;
- объяснить `BFS` своими словами и связать с backend-сценарием;
- объяснить `task processing.` своими словами и связать с backend-сценарием;
...
В теме **Queue/deque** важно уверенно объяснять следующие части:

### FIFO

Для `FIFO` назови input constraints, data structure, complexity и boundary cases до написания кода.

### BFS

Для `BFS` назови input constraints, data structure, complexity и boundary cases до написания кода.
...
1. Объясни **Queue/deque** по схеме «определение → механизм → пример → ограничение».
...
- дай точное определение **Queue/deque**;
