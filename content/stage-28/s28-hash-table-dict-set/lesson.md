...
- объяснить `average complexity` своими словами и связать с backend-сценарием;
- объяснить `collisions awareness` своими словами и связать с backend-сценарием;
- объяснить `membership/deduplication.` своими словами и связать с backend-сценарием;
...
В теме **Hash table/dict/set** важно уверенно объяснять следующие части:

### average complexity

Для `average complexity` назови input constraints, data structure, complexity и boundary cases до написания кода.

### collisions awareness

Для `collisions awareness` назови input constraints, data structure, complexity и boundary cases до написания кода.

### membership/deduplication

Для `membership/deduplication` назови input constraints, data structure, complexity и boundary cases до написания кода.
...
1. Объясни **Hash table/dict/set** по схеме «определение → механизм → пример → ограничение».
...
- дай точное определение **Hash table/dict/set**;
