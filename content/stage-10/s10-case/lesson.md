...
- объяснить `conditional projection` своими словами и связать с backend-сценарием;
- объяснить `grouped reporting.` своими словами и связать с backend-сценарием;
...
В теме **CASE** важно уверенно объяснять следующие части:

### conditional projection

Для `conditional projection` сначала определи grain/cardinality результата, затем NULL и ordering semantics.
...
1. Объясни **CASE** по схеме «определение → механизм → пример → ограничение».
