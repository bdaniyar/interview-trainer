...
- объяснить `fast-forward` своими словами и связать с backend-сценарием;
- объяснить `merge commit` своими словами и связать с backend-сценарием;
- объяснить `conflicts.` своими словами и связать с backend-сценарием;
...
В теме **merge** важно уверенно объяснять следующие части:

### fast-forward

Для `fast-forward` сначала назови изменяемое состояние Git: working tree, index, branch pointer или shared history.

### merge commit

Для `merge commit` сначала назови изменяемое состояние Git: working tree, index, branch pointer или shared history.

### conflicts

Для `conflicts` сначала назови изменяемое состояние Git: working tree, index, branch pointer или shared history.
...
1. Объясни **merge** по схеме «определение → механизм → пример → ограничение».
